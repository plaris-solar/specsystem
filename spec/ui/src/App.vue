        ...
        <div>
          <q-btn-dropdown label="Help" flat icon="help_outline" data-cy="app-help-btn">
            <q-list>
              ...
              <q-item
                clickable
                :href="apiServerHost + '/help/design'"
                target="_blank"
...
import { apiServerHost, retrieveData } from "./utils";
