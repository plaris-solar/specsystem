...
<script setup>
    ...
    const columns = [
            { name: 'name', align: 'center', label: 'Name', field: 'name', classes: "tab page-col", headerStyle:"font-size:large;", style: 'width: 15em;', sortable: true},
            { name: 'readRoles', align: 'center', label: 'Read Roles', field: 'readRoles', classes: "tab page-col", headerStyle:"font-size:large;", style: 'width: 15em;', sortable: true},
        ]
</script>
