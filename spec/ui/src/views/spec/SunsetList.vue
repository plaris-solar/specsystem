                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                        <q-td v-for="col in props.cols" :key="col.name" :props="props" class='text-center'>
                            ...
                            <span v-else-if="['sunset_dt', 'approved_dt', 'sunset_extended_dt'].includes(col.name)">{{dispDate(props.row[col.name])}}</span>
...
<script>
import { dispDate, retrieveData, } from '@/utils.js';
...
<script setup>
    ...
    const columns = [
            { name: 'sunset_dt', align: 'left', label: 'Sunset', field: 'sunset_dt', classes: "tab page-col", headerStyle:"font-size:large;", style: 'width: 15em;', sortable: false},
            ...
            { name: 'approved_dt', align: 'left', label: 'Approved', field: 'approved_dt', classes: "tab page-col", headerStyle:"font-size:large;", style: 'width: 15em;', sortable: false},
            { name: 'sunset_extended_dt', align: 'left', label: 'Extended', field: 'sunset_extended_dt', classes: "tab page-col", headerStyle:"font-size:large;", style: 'width: 15em;', sortable: false},
        ]
</script>
