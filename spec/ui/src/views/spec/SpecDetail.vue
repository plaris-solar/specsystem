<template>
    ...
    <q-card-section class="row">
      ...
      <q-card-actions>
        ...
        <q-btn
          v-else
          :label="
            (state != 'Active' ? 'This is not an Active revision. Click to ' : '') +
            'Show Revisions'
          "
      ...
      <span
        v-show="
          (state_loaded === 'Active' || state_loaded === 'Obsolete') && isAuthenticated
        "
      >
        <q-card-actions>
          <q-btn
      ...
      <table class="paddingBetweenCols">
        ...
        <tr>
          ...
          <td
            ...
            :bgcolor="
              new Date().getTime() > sunset_warn_dt && state === 'Active' ? 'orange' : ''
            "
          >
      ...
      >
        ...
        <template v-slot:body="tprops">
          <q-tr>
            ...
            <q-td v-show="!edit">
              <router-link
                :to="'/ui-spec/' + tprops.row['num'] + '/' + tprops.row['ver']"
  ...
  <q-dialog v-model="extend_spec">
    <extend-spec-dialog :num="props.num" :ver="props.ver" @updateSpec="loadSpec()" />
  </q-dialog>
  ...
  <q-dialog v-model="revise_spec">
    <revise-spec-dialog :num="props.num" :ver="props.ver" @updateSpec="loadSpec()" />
  </q-dialog>
